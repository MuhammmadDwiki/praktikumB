...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Nov 2023 pada 13.08
...
--
ALTER TABLE `game`
  MODIFY `id_game` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `pembayaran`
  MODIFY `id_pembayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;
