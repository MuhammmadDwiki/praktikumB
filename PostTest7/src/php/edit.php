...
if (isset($_POST['edit'])) {
    ...
    if (move_uploaded_file($tmp,'../assets/'.$gambar_baru)) {
            $result = mysqli_query($conn, "UPDATE mainan SET NAMA = '$nama', ALAMAT='$alamat', JENIS_MAINAN='$jenis', JUMLAH_MAINAN = '$jumlah', NO_HP = '$nomor', GAMBAR_MAINAN = '$gambar_baru' WHERE ID = '$id' ");
            if ($result) {
                echo "
                <script>
    ...
    <div class="container">
        <div class="box form-box">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="field input">
                    <label for="Gambar_Mainan">Upload Gambar</label>
                    <input type="file" name="GAMBAR_MAINAN" value="<?php echo $mainan['GAMBAR_MAINAN']?>" autocomplete="off" required>
                </div>
